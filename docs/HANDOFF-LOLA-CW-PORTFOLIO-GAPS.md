...
4. **Checkout Ops** — *During the first 72 hours of La Bodega’s live launch, organized a three-team recovery (aisle audit + checkout incidents): corrected ~2,000 UPC records, introduced unit-cost and market-price verification, and independently revalidated via Odoo POS + Datalogic while supporting 500+ transactions.* (500+ = window transactions; ~2,000 = corrected records; no invented recognition %.)
