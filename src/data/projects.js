  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: 'Product truth fixed. Shift truth still broken.',
        body: 'Registers could sell. People, trucks, and money still ran on paper clocks, hourly Excel, and WhatsApp. Chapter 02 — La Bodega Ops — closes who works, what arrived, and who decides.',
      },
    ],
  },
  {
    slug: 'la-bodega-ops',
    outcome: 'La Bodega Ops — Purchasing, Store Pulse, budgets off Excel',
    title: 'La Bodega Ops',
    meta: 'La Bodega · Mercado · 2026',
    status: 'Live · UI ~85%',
    year: '2026',
    domain: 'Product design',
    layer: 'Ops · TIME · CONTROL',
    cover: '/work/la-bodega-ops/cover.png',
    hero: '/work/la-bodega-ops/hero.png',
    blurb:
      'I designed La Bodega Ops for Mercado: Purchasing (Walk with vendor, Door delivery), Store Pulse, dept budgets, and verified clock. Work updates on phone; Excel exports.',
    role: 'Product designer',
    timeline: 'Q1–Q2 2026',
    team: 'Solo design & build · with store ops · CEO decisions',
    skills: ['Product design', 'Service design', 'PWA', 'IA', 'Ops systems'],
    accent: '#9F1239',
    liveUrl: 'https://labodega-ops-ivory.vercel.app',
    caseStudyBody: 'la-bodega-ops',
    layout: 'product',
    sections: [],
  },
  {
