...
export const work = [
  {
    ...
    accent: '#1FA97A',
    href: 'https://la-bodega-lola-nu.vercel.app/',
    ...
    sections: [
      {
        ...
        body: 'La Bodega is an independent Hispanic grocer in Calhoun, GA. Weekly flyer / loyalty reach is ~1,200 (CRM size can run larger; do not treat 1,600+ as weekly loyalty). Replies (English, Spanish, voice notes, SNAP questions, shopping lists) used to pile into one staff inbox. Lola is the guest + staff product on that stack — not the entire CRM (Broadcasts / Pipelines / Automations stay elsewhere). Competitor Watch owns planning and visit attribution; Lola owns conversation, orders, and ops handoff.',
      },
      {
        eyebrow: 'Problem',
      ...
      },
      {
        ...
        body: 'If Lola can answer flyer questions instantly and turn messy replies into structured pickup requests, the broadcast becomes more than marketing — a way to order without downloading a new app.',
      },
      {
        eyebrow: 'Guest flows',
        title: 'Six bilingual flows on WhatsApp',
        body: 'Broadcast (weekly flyer push). Greeting (EN/ES entry). Pickup (buttons-first quote→confirm; #order only for power users). Reminders (shopping / offer). Confused / coach (guided recovery when intent is messy). Staff handoff (hard asks escalate; Lola pauses when a human owns the thread).',
      },
      {
        eyebrow: 'Lola Connect',
        title: 'Staff PWA spine: Home · Inbox · Orders · Tickets · Reminders',
        body: 'Designed and built Lola Connect solo as a mobile PWA for the floor phone. Two-tier alerts: draft-order buzz → staff confirm, plus pickup-soon nudges. Staff see orders, tickets, and reminders in one spine — not a generic chatbot inbox.',
      },
      {
        eyebrow: 'Craft / safety',
        title: 'Flyer-grounded answers. No invented prices.',
        body: 'Deals answers stay grounded in the weekly flyer — Lola does not invent SKU prices or open-inventory fantasy. When a human owns the thread, the bot pauses. Voice is text-first; reminder TTS has an EN-only cron gap documented as a production honesty note.',
      },
      {
        eyebrow: 'Research',
        title: '180 threads before a single flow shipped',
        body: 'May–Jun 2026 inbox study: 180 conversations · 310 customer messages. Spanish led among threads with a saved language preference.',
        metrics: [
          { value: '180', label: 'Threads reviewed' },
          { value: '310', label: 'Customer messages coded' },
          { value: '96.3%', label: 'Closed without staff' },
        ],
      },
      {
        eyebrow: 'Metrics',
        title: 'Measured — and still measuring',
        body: '96.3% of conversations closed without staff. 97.7% of first bot replies under 2 min (median ~4s). Still measuring (test traffic filtered): pickup lead-time, escalate solve/expire rates. Escalation expire % is not published as a hero metric while contaminated by test tickets.',
        metrics: [
          { value: '~1,200', label: 'Weekly flyer / loyalty reach' },
          { value: '96.3%', label: 'Closed without staff' },
          { value: '97.7%', label: 'First reply <2 min' },
        ],
      },
      {
        eyebrow: 'What I learned',
        title: 'Ship the handoff, not just the bot',
        body: 'Conversation craft only works when staff ops are designed with it. Lock-screen alerts, quote flows, and clear escalation rules mattered as much as the agent prompts. Ownership stays clear: flows + Connect spine — not the whole CRM.',
      },
    ],
  },
  {
