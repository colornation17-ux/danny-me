  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Fans, sponsors, engineers, and drivers hit the same shallow content, nobody found what they came for. High bounce, short sessions, thin content, no SEO structure, and no reason to stay.',
      },
      {
        eyebrow: 'Research',
        title: 'Track, surveys, and competitive analysis',
        body: 'Applied Nielsen Norman Group heuristics to identify friction, audited leading motorsports sites for fan-engagement best practices, ran 30+ fan and sponsor surveys, and conducted field research at Indianapolis Motor Speedway. Literature backing: 70% of organizations cite B2B sponsorships as essential, and 61% of F1 fans engage with digital content daily.',
      },
      {
        eyebrow: 'Strategy',
        title: 'Persona-driven IA, SEO-mapped content, racing DNA design system',
        body: 'Established flat hierarchy through card sorting, reducing clicks to key information. Mapped SEMrush keyword findings into navigation priorities for sponsors and engagement touchpoints for fans. Adopted a red-and-black design system reflecting CODE19\'s racing DNA, with a sitemap covering all four persona flows.',
      },
      {
        eyebrow: 'Outcomes',
        title: 'Sessions, funding, and organic durability',
        body: 'Seed funding grew from $150K to $500K post-launch. New monthly sessions peaked at 1,500+ in December 2024 with direct traffic averaging 3.6 min per session. Organic search started near zero at launch and grew steadily through mid-2025, the slower, more durable payoff of the SEO work.',
        metrics: [
      ...
      },
      {
        ...
        body: 'Real-time feeds from multiple third-party sources required demanding technical coordination. Serving four audiences on one platform meant real IA trade-offs, not just responsive breakpoints. Next: broader usability testing, and gradually introducing interactive analytics and AR/VR modules.',
      },
    ],
  },
  {
